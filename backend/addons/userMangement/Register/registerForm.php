...
<div class="container-fluid">
    <form class="col-xs-6 col-xs-offset-3" accept-charset="UTF-8" role="form" id="register-form" method="post"
          action="backend/addons/usermangement/register/register.php">
        <h4 class="">
            Signin!
        </h4>
        <fieldset>
