...
/////////////////////////////////////////////////////////////
function registerNewUser($username, $userEmail, $userPassword, $userRole)
{
    $conn = db_connect();
...
/**
 * check that RoleTitle is unique;
 */
function isUniqueRoleTitle($title, $tbl)
{
    $conn = db_connect();
 ...
 */
function isUniqueUsername($username, $tbl)
{
    $conn = db_connect();
    $sql = "SELECT userName
          FROM  `$tbl`
...
/**
 * check that userEmail is unique;
 */
function isUniqueUserEmail($userEmail, $tbl)
{
    $conn = db_connect();
    ...
    /**
     * check that current user id admin;
     */
    function isAdmin($id)
    {
        $conn = db_connect();
